...
Breadcrumbs::register('verify', function (Crumbs $crumbs) {
    $crumbs->parent('home');
...
Breadcrumbs::register('password.confirm', function (Crumbs $crumbs) {
    $crumbs->parent('password.request');
    $crumbs->push('Confirm', route('password.confirm'));
});
